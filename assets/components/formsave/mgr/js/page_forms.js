		...
		this.formGrid = new Ext.grid.GridPanel({
		    ...
		    columns: [
		        ...
		        },
		        {
		            ...
		            header: _('published'),
		            renderer: function(value) {
		            	return value==1?_('formsave.published_yes'):_('formsave.published_no');
		            } 
		        }
